...
# clu <- readRDS('/celltype/cancer/bcl/data/proc/ct.rds')
...
# saveRDS(pred,file='/celltype/cancer/bcl/SingleR/fullpred.rds')
# saveRDS(rt,file='/celltype/cancer/bcl/SingleR/time.rds')
...
# saveRDS(ct,file='/celltype/cancer/bcl/SingleR/res.rds')
